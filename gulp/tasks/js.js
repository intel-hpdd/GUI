...
exports.jsDepsDev = function jsDepsDev() {
  return jsDeps(jsDepsDev).pipe(gulp.dest('./dist'));
};

exports.jsDepsProd = function jsDepsProd() {
  return jsDeps(jsDepsProd).pipe(gulp.dest('./dist'));
};
...
exports.systemConfigDev = function systemConfigDev() {
  return systemConfig(systemConfigDev).pipe(gulp.dest('./dist'));
};
