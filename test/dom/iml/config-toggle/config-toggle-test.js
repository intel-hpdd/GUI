describe('config toggle', () => {
  ...
  <div class="when-active" ng-if="configToggle.active()">
    <button class="set-inactive" ng-click="configToggle.setInactive()" class="btn btn-cancel btn-block">Cancel</button>
  </div>
</div>`;
