...
describe('jobstats resolves', () => {
  ...
  beforeEachAsync(async function () {
    topDuration = jasmine
      ...
      .and
      .returnValue(highland(['topDuration']));

    topRange = jasmine
      .createSpy('topRange')
      .and
      .returnValue('topRange');
  ...
  describe('jobstats$', () => {
    itAsync('should select duration when there is no id prop', async function () {
      await jobstats$({});
    ...
    itAsync('should return duration info if there is no id prop', async function () {
      const result = await jobstats$({})
  ...
  describe('getData', () => {
    ...
    itAsync('it should return a label when there is an id prop', async function () {
