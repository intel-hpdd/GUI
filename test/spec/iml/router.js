describe('The router', function () {
  ...
  beforeEach(module('imlRoutes', 'auth', 'socket-module'));

  var addProperty, resolveStream;

  beforeEach(inject(function (_GROUPS_, _$rootScope_, _$q_, _addProperty_, _resolveStream_) {
    GROUPS = _GROUPS_;
