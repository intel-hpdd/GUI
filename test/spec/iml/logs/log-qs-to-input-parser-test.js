...
describe('log qs to input parser test', () => {
  const inputOutput = {
    ...
    __in: new Error(
      'Expected one of datetime, tag, message_class, fqdn, value, order_by got __in at character 0'
    ),
    'a&': new Error(
      'Expected one of __contains, __startswith, __endswith, __in, __gte, __lte, __gt, __lt, = got & at character 1'
    ),
    'a=b&&': new Error(
      'Expected one of datetime, tag, message_class, fqdn, value, order_by got & at character 4'
    ),
    'a__in=b&&': new Error(
