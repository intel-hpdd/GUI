...
System.import('/base/dist/test/global-setup.js')
  .then(() =>
    System.import(
      '/base/dist/node_modules/intel-jasmine-n-matchers/jasmine-n-matchers'
    ))
  .then(() => Promise.all(testFiles.map(f => System.import(f))))
  .then(
