...
module.exports = function setConfig (config) {
  ...
  config.set({
    ...
    files: [
      ...
      nodeModulesDir('d3/d3.js'),
      nodeModulesDir('nvd3/build/nv.d3.js'),
      ...
      nodeModulesDir('intel-big-differ/dest/umd/source/diff-component.js'),
      nodeModulesDir('intel-big-differ/dest/umd/source/diff-container.js'),
      nodeModulesDir('intel-big-differ/dest/umd/source/diff-model.js'),
      nodeModulesDir('intel-big-differ/dest/umd/source/reset-diff.js'),
      nodeModulesDir('intel-big-differ/dest/umd/source/*-module.js'),
