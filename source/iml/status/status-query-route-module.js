...
import statusContainerTemplate from './assets/html/status-container';

export default angular.module('statusQueryRouteModule', [statusContainerTemplate])
  .config(function statusSegment ($routeSegmentProvider) {
    ...
    $routeSegmentProvider
      ...
      .segment('statusQuery', {
        ...
        controllerAs: 'ctrl',
        templateUrl: statusContainerTemplate,
