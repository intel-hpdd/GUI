...
export default () => {
  return (
    <div>
      ...
      <br />
      <div>
        Do not use or load this software and any associated documentation (collectively, the "Software" or "Materials") until you have carefully read the following terms and conditions. By selecting "Agree" below, or by loading or using the Software, you agree to the terms of this license agreement (the "License Agreement"). If you do not wish to agree, click "Do Not Agree" and do not install or use the Software. If you are an employee or agent of a legal entity, you represent and warrant that you have the authority to bind such legal entity to this Agreement.
      </div>
      <br />
      <div>
        The Software includes both open source and proprietary software that are provided by Intel Corporation or its majority-owned subsidiaries ("Intel") with this License Agreement, and any other accompanying documentation. The open source components include (i) the Intel® Enterprise Edition for Lustre*software (Intel® EE for Lustre* software), and (ii) the Intel® Hadoop Adaptor for Lustre* software (collectively, the "Intel Open Source Software"). The proprietary components include (i) the Intel® Manager for Lustre* software ("Intel Manager") and (ii) any other components that are marked as "Intel proprietary" or with a similar legend (collectively, the "Intel Software"). "Lustre System" means hardware storage products and hardware server products sold or resold by Intel or its resellers ("Reseller") which use an open source Lustre file system for high performance computing on Linux. "Management Server" means a computer server used to store and operate the Intel Manager software. "Object Storage Server(s)" means a computer server used to store Lustre file information and components of the Intel Software and to communicate with storage products used to store the Lustre file system data.
      </div>
      <br />
      <div>
        <div>
        ...
        <div>
          <strong>1.1</strong>
          {' '}
          Licenses for the Intel Open Source Software. The Intel Open Source Software will be governed by the open source licenses accompanying such materials.
        </div>
        <br />
      ...
      <div>
        ...
        <div>
          <strong>2.2</strong>
          {' '}
          If you increase the number of Object Storage Servers used in your Lustre System from the number you originally purchased from an authorized Intel reseller, you must notify your Reseller or Intel and pay the additional support fees based upon the number of additional Object Storage Servers you have added to your Lustre System.
        </div>
        <br />
      </div>
      <br />
      ...
      <div>
        ...
        {' '}
        IN NO EVENT SHALL INTEL OR ITS SUPPLIERS OR VENDORS OR THIRD PARTY SOFTWARE OWNERS BE LIABLE FOR ANY DAMAGES WHATSOEVER (INCLUDING, WITHOUT LIMITATION, LOST PROFITS, BUSINESS INTERRUPTION, OR LOST INFORMATION) ARISING OUT OF THE USE OF OR INABILITY TO USE THE SOFTWARE, EVEN IF INTEL HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. SOME JURISDICTIONS PROHIBIT EXCLUSION OR LIMITATION OF LIABILITY FOR IMPLIED WARRANTIES OR CONSEQUENTIAL OR INCIDENTAL DAMAGES, SO THE ABOVE LIMITATION MAY NOT APPLY TO YOU. THE WARRANTY DISCLAIMER AND LIMITATIONS ON LIABILITY IN THIS AGREEMENT ARE FUNDAMENTAL ELEMENTS OF THE AGREEMENT BETWEEN INTEL AND YOU REGARDING THE MATERIALS. INTEL WOULD NOT BE ABLE TO PROVIDE THE MATERIALS TO YOU WITHOUT SUCH LIMITATIONS.
      </div>
      <br />
      <div>
        <h5>8. UNAUTHORIZED USES.</h5>
        {' '}
        THE SOFTWARE IS NOT DESIGNED, INTENDED, OR AUTHORIZED FOR USE IN ANY MEDICAL, LIFE SAVING OR LIFE SUSTAINING SYSTEMS, OR FOR ANY OTHER APPLICATION IN WHICH THE FAILURE OF THE SOFTWARE COULD CREATE A SITUATION WHERE PERSONAL INJURY OR DEATH MAY OCCUR. Should You purchase or use the Software for any such unintended or unauthorized use, You shall indemnify and hold Intel and its officers, subsidiaries and affiliates harmless against all claims, costs, damages, and expenses, and reasonable attorney fees arising out of, directly or indirectly, any claim of product liability, personal injury or death associated with such unintended or unauthorized use, even if such claim alleges that Intel was negligent regarding the design or manufacture of the part.
      </div>
      <br />
      <div>
