 ...
 */
const naturalSortAlgorithm = getStringToSort => (a, b) => {
 ...
 */
export function naturalSortFilter(input, predicate, reverse) {
  const sorter = naturalSortAlgorithm(predicate);
  const sortedArray = [...input].sort(sorter);
