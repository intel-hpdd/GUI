...
import { getReadLocks, getWriteLocks } from "../locks/locks-utils.js";
import { type GetTypeLocksT, getLocksDiff } from "../locks/locks-utils.js";

import { type LockT, type LockEntryT } from "../locks/locks-reducer.js";
