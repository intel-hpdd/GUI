...
import type { windowUnloadT } from "../window-unload.js";
...
export default function disconnectModalFactory(windowUnload: windowUnloadT, $uibModal: Object, $timeout: Function) {
  "ngInject";
  const options = {
    backdrop: "static",
    keyboard: false,
