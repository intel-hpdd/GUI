...
angular.module('target')
  .value('filterTargetByHost', function filterTargetByHost (id) {
    var failoverServersLens = fp.lensProp('failover_servers');
    var primaryServer = fp.lensProp('primary_server');
