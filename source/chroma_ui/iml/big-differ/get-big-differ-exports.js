...
export const diffObj3 = fp.curry(4, function diffObj3Factory (lensMap, a, b, c) {
...
export function diffObjInColl3Factory (diffObj3, matchInColl) {
  'ngInject';
...
export function mergeObjFactory (diffObj3) {
  'ngInject';
...
export const matchInColl = fp.curry(3, function matchInColl (idLens, coll, item) {
  var eqIdLens = fp.eqLens(nullSafe(idLens), item);
  return fp.find(eqIdLens, coll);
});

export function mergeCollFactory (mergeObj, matchInColl) {
  'ngInject';
...
export function BigDiffer (diffObj3, mergeObj, mergeColl, diffObjInColl3) {
  'ngInject';
