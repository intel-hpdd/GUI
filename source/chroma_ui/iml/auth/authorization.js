...
(function () {
  ...
  angular.module('auth').directive('restrictTo', ['authorization', function restrictTo (authorization) {
    return {
  ...
  angular.module('auth').directive('restrict', ['authorization', function restrict (authorization) {
    return {
      link: function link ($scope, el, attrs) {
