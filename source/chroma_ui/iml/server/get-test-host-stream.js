...
angular.module('server').factory('getTestHostStream', ['throwIfServerErrors',
  function getTestHostStreamFactory (throwIfServerErrors) {
    'use strict';

    /**
     * Tests host with provided data.
     * Keeps asking about the server's status.
     * @param {Function} spring Creates streams.
