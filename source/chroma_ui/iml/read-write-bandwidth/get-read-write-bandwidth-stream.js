...
angular.module('readWriteBandwidth')
  .factory('getReadWriteBandwidthStream', ['λ', 'socketStream', 'chartPlugins',
    function getReadWriteBandwidthStreamFactory (λ, socketStream, chartPlugins) {
      'use strict';
      ...
      return function getReadWriteBandwidthStream (requestRange, buff) {
        var s = λ(function generator (push, next) {
          ...
          socketStream('/target/metric', params, true)
            ...
            .through(chartPlugins.toNvd3(['read', 'write']))
